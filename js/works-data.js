...
const WORKS_DATA = [
  ...
  },
  {
    ...
    purpose:
      "物流会社の取引先候補・荷主に向けて、事業内容と安全管理体制を伝える1ページ構成の企業サイトを制作。コピー・構成・フォーム実装に加え、コンセプト写真の選定・実装まで一貫して対応。",
    target: "幹線輸送・地域配送・倉庫保管/3PLの委託先を検討している荷主企業の物流・購買担当者。",
    challenge:
      "初期実装時点でHero・会社案内セクションに写真が一切なく、コピーや構成の完成度に対して「未完成のテンプレート」に見えるリスクがあった（imagery面のP0課題）。",
    designConcept:
      "ブランドカラー（ネイビー×オレンジ）に合わせたAIコンセプト写真をHero背景・会社案内セクションに実装し、既存のネイビーグラデーション演出を保ったまま物流業らしい信頼感を強化。",
    informationArchitecture:
