...
4. **行長 57字（/aichi/ は70字）は日本語の可読域（35〜45字）を超えている。**
   anthropic 17字 / stripe 23字 / goodpatch 46字 と比べて明確に長い。

→ 1〜4 は独立した好みの問題ではなく、**同じ一つの結果**を生んでいる：
